...
public class AESDecrypt extends AbstractFunction {
	public static String functionName = "__decryptAES";
	...
	public String execute(SampleResult previousResult, Sampler currentSampler) throws InvalidVariableException {
		...
		String strToDecrypt = ((CompoundVariable) values[0]).execute().trim();  //parameter 1
		String secret = ((CompoundVariable) values[1]).execute().trim();  //parameter 2

		String result = AES.decrypt(strToDecrypt, secret);
